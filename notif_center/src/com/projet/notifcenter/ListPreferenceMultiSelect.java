...
public class ListPreferenceMultiSelect extends ListPreference {
    ...
    public ListPreferenceMultiSelect(Context context, AttributeSet attrs) {
        super(context, attrs);
        //QuickPrefsActivity.getApplications().length ne fonctionne pas ici
        mClickedDialogEntryIndices = new boolean[QuickPrefsActivity.getApplications().length];
        //System.out.println(QuickPrefsActivity.getApplications().length);
    ...
    protected void onPrepareDialogBuilder(Builder builder) {
    	CharSequence[] entries = QuickPrefsActivity.getApplications();
    	CharSequence[] entryValues = QuickPrefsActivity.getApplications();
    ...
    private void restoreCheckedEntries() {
    	...
    	String[] vals = parseStoredValue(getValue().toString());
    	if ( vals != null ) {
