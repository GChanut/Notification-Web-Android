...
define("CONSUMER_KEY", "5bf2249015df8f82bb7f39c11991c8f405042a1f9");
define("CONSUMER_SECRET", "f610d7dbcbe0dd1a386843178beb0380");
//Ici il faut qu'on trouve la solution !
define("USER_ID","1");
...
try {
  ...
  if (empty($_GET["oauth_token"])) {
    ...
    $callback_uri = 'http://notifcenter.zapto.org/oauth2m/client/clientCV.php?consumer_key='.rawurlencode($consumer_key).'&usr_id='.intval($user_id);
